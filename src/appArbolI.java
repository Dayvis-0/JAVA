public class appArbolI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb_metodo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Esta vacio", "Nodo", "Recorre nodos", "Contar nodos", "Es hijo", "Es padre", "Pre-orden", "In-orden (tarea)", "Pos-orden (tarea)", "Padre (tarea)", "Contar padres", "Contar hijos", "Existe", "Altura", "Mayor", "Recorre padres", "Recorre hijos", "Nivel" }));
    ...
    private void bu_ejecutarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bu_ejecutarMouseClicked
        ...
        switch (opc) {
            ...
            case 12: ta_rta.setText("Existe: "+aAi.existe(tf_hijo.getText())); break;
            case 13: ta_rta.setText("Altura: "+aAi.altura()); break;
            case 14: ta_rta.setText("Mayor: "+aAi.mayor()); break;
            case 15: ta_rta.setText("Padres: "+aAi.recorrePadre()); break;
            case 16: ta_rta.setText("Hijos: "+aAi.recorreHijo()); break;
