...
public class cArbolI {
    ...
    public boolean existe(Object pHijo){
        boolean rta= false;
        if(!estaVacio()){
            Stack<cNodoA> pila= new Stack<>();
            pila.push(aRaiz);
            ...
            while(!pila.isEmpty() && !rta){
                dir= pila.pop();
                if(dir.sElemento().toString().equals(pHijo.toString())){ rta= true; }
                else{
                    if(dir.sPhijo() != null){ pila.push(dir.sPhijo()); }
                    if(dir.sShermano() != null){ pila.push(dir.sShermano()); }
                }
    ...
    public Object mayor(){
        ...
        if(!estaVacio()){
            ...
            while(!pila.isEmpty()){
                dir= pila.pop();
                if(dir.sElemento().toString().compareTo(rta.toString())>0){ rta= dir.sElemento(); }
                if(dir.sPhijo() != null){ pila.push(dir.sPhijo()); }
                if(dir.sShermano() != null){ pila.push(dir.sShermano()); }
            }
        }return rta;
    ...
    public String recorrePadre(){
        ...
        if(!estaVacio()){
            ...
            while(!pila.isEmpty()){
                dir= pila.pop();
                if(dir.sPhijo() != null){ rta= rta+" "+dir.sElemento(); pila.push(dir.sPhijo()); }
                if(dir.sShermano() != null){ pila.push(dir.sShermano()); }
            }
        }return rta;
    }
    ...
    public boolean equiExtremo(){
        boolean rta= false;
        if(!estaVacio()){ rta= (primeros()==ultimos()); }
        return rta;
    }
}