public class lista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb_operacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Esta vacio", "Iesimo", "Longitud", "Posicion", "Mostrar", "Mostrar invertido", "Mostrar duplicado", "Insertar último", "Insertar primero", "Insertar ordenado", "Máximo", "ordenado ascendente" }));
    ...
    private void bu_ejecutarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bu_ejecutarMouseClicked
        ...
        switch (posicion) {
            ...
            case 11: la_respuesta.setText("ordenado ascendete: "+aL.ordenadoAsc()); break;
            default:
