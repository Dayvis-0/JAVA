public class opListas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb_operacionL.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Concatenar lista", "Mostrar lista" }));
    ...
    private void bu_ejecutarLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bu_ejecutarLMouseClicked
        ...
        switch (posicion) {
            case 0: la_respuestaL.setText("Lista concatenada"); aL= concatenarLista(aL1, aL2, new cLista());
            case 1: la_respuestaL.setText("Mostrar: "+aL.mostrar()); break;
            default:
            throw new AssertionError();
        }
