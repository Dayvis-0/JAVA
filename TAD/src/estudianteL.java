public class estudianteL extends javax.swing.JFrame {
    //... declarar clase
    private cLista aL;
    public estudianteL() {
        initComponents();
    ...
    private void bu_registrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bu_registrarMouseClicked
        ...
        cEstudiante e1= new cEstudiante();
        ...
        aL.insertar(e1, Integer.parseInt(tf_posicion.getText()));
        //... limpiar
        limpiarDatos();
    ...
    private void bu_mostrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bu_mostrarMouseClicked
        cEstudiante e1= (cEstudiante)aL.iesimo(Integer.parseInt(tf_posicion.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estudianteL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estudianteL().setVisible(true);
            }
        });
    }
